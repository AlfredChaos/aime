...
StdIO MCP 服务器只有有状态客户端，当调用 connect() 时，它将在本地启动 MCP 服务器然后连接到它。
...
/opt/hostedtoolcache/Python/3.10.19/x64/lib/python3.10/contextlib.py:103: DeprecationWarning: Use `streamable_http_client` instead.
...
小技巧
可选地，开发者可以通过指定组名来管理工具。有关分组工具管理，请参考 工具 部分。
...
函数调用结果：
ToolResponse(content=[{'type': 'text', 'text': '{"results":[{"country":"中国","province":"北京市","city":"北京市","citycode":"010","district":"东城区","street":[],"number":[],"adcode":"110101","location":"116.397755,39.903182","level":"兴趣点"}]}'}], metadata=None, stream=False, is_last=True, is_interrupted=False, id='2026-02-15 03:05:10.374_ae5d2a')
