...
长期记忆¶
AgentScope 为长期记忆提供了一个基类 LongTermMemoryBase 和一个基于 mem0 的具体实现 Mem0LongTermMemory。
结合 智能体 章节中 ReActAgent 类的设计，我们提供了两种长期记忆模式：
...
Friday: 根据你的喜好，我建议你可以考虑住在西湖附近或龙井村一带的民宿。这些地方环境优美，交通便利，而且很多民宿都充满当地特色，能让你更好地感受杭州的文化氛围。如果你需要，我可以帮你查找一些评价较好的民宿供你参考。你对民宿有什么特别的要求吗?比如价格区间、设施等。
...
备注
在 GitHub 仓库的 examples/long_term_memory/reme 目录下我们提供了 ReMe 长期记忆的使用示例。
